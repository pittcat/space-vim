nnoremap <silent> <F4> :Defx -split=vertical -winwidth=50 -direction=topleft -columns=git:mark:filename:type<CR>
" inoremap <silent> <F4> <ESC>:NERDTreeToggle<CR>
" nnoremap <silent> <Leader>ft :NERDTreeToggle<CR>
let NERDTreeChDirMode=0
noremap <silent> <leader>nc :Defx `expand('%:p:h')` -search=`expand('%:p')` -split=vertical -winwidth=50 -direction=topleft -columns=git:mark:filename:type<cr>
