MP 'neoclide/coc.nvim', {'tag': '*', 'do': { -> coc#util#install()},'on_event': ['CursorHold', 'CursorHoldI', 'InsertEnter'] }
...
MP 'neoclide/coc-jedi', {'do': 'yarn install','on_event': ['CursorHold', 'CursorHoldI', 'InsertEnter'] }
