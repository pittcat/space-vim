...
function! spacevim#defer#filemanage(timer) abort
  call s:lod('vim-mundo','vim-auto-save','vim-eunuch')
endfunction
...
function! spacevim#defer#awesome_tools(timer) abort
  call s:lod('nginx.vim','vim-table-mode','vim-lastplace','vim-smartim','zeavim.vim','open-browser.vim','vim-search-me','dict.vim','vim-highlightedyank','vim-codelf')
endfunction
